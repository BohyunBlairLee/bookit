...
export class MemStorage implements IStorage {
  ...
  async addBook(insertBook: InsertBook): Promise<Book> {
    ...
    const book: Book = { 
      ...
      publishedDate: insertBook.publishedDate ? new Date(insertBook.publishedDate) : null,
      userId: insertBook.userId,
      status: insertBook.status || "want",
      rating: insertBook.rating || null,
      completedDate: insertBook.completedDate ? new Date(insertBook.completedDate) : null,
